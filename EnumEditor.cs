...
namespace RuntimeInspector {
	internal class EnumEditor : MonoBehaviour {
		...
		void Start() {
			...
			dropLabelT.font = ViewerCreator.font;
			dropLabelT.fontSize = ViewerCreator.FontSize;
			...
			dropLabelR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreator.Size * 0.8f);
			...
			viewPortR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, dropD.options.Count * ViewerCreator.Size * 0.8f);
			...
			contentR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreator.Size * 0.8f);
			...
			itemR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreator.Size * 0.8f);
			...
			itemLabelT.font = ViewerCreator.font;
			itemLabelT.fontSize = ViewerCreator.FontSize;
			...
			itemLabelR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreator.Size * 0.8f);
			...
			dropR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreator.Size * 0.8f);
			...
			dropD.onValueChanged.AddListener(index => {
				set?.Invoke(enums[index]);
			});
		}

		private void Update() {
			if (get != null) {
				dropD.value = enums.IndexOf(get());
			}
		}
	}
}