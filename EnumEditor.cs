...
namespace InGameDebugger {
	public class EnumEditor : MonoBehaviour {
		...
		void Start() {
			...
			dropLabelT.font = ViewerCreater.font;
			dropLabelT.fontSize = ViewerCreater.fontSize;
			...
			dropLabelR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreater.size * 0.8f);
			...
			viewPortR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, dropD.options.Count * ViewerCreater.size * 0.8f);
			...
			contentR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreater.size * 0.8f);
			...
			itemR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreater.size * 0.8f);
			...
			itemLabelT.font = ViewerCreater.font;
			itemLabelT.fontSize = ViewerCreater.fontSize;
			...
			itemLabelR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreater.size * 0.8f);
			...
			dropR.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, ViewerCreater.size * 0.8f);
